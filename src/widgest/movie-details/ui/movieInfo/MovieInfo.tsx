  ...
  return (
    <>
      <div className={s.posterCol}>
        <MoviePoster posterPath={data.poster_path} title={data.title} variant={'details'} />
      </div>
